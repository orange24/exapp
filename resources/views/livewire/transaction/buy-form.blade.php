<div class="p-4" x-data="buyForm()" x-ref="lwRoot">
    ...
    <div class="mb-4 p-3 bg-blue-50 border border-blue-200 rounded">
        <div class="flex flex-wrap gap-3 items-end">
            ...
            <div style="width:120px; flex-shrink:0;">
                ...
                <input type="text" value="{{ number_format($currentTotal, 2) }}" readonly
    ...
    @if ($showPrintSlip && $savedTransactionId)
        <div class="mb-4 p-3 bg-green-50 border border-green-300 rounded flex items-center justify-between">
            <span class="text-green-700 font-semibold">บันทึกสำเร็จ! กำลังพิมพ์ใบเสร็จ...</span>
            <a href="{{ route('transaction.print', $savedTransactionId) }}?print=Y" target="_blank"
               class="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 text-sm">
                พิมพ์อีกครั้ง
            </a>
        </div>
        <iframe src="{{ route('transaction.print', $savedTransactionId) }}?print=Y"
