<div x-data="{
    ...
    <div class="bg-white rounded-lg shadow p-4 mb-4">
        <div class="flex flex-wrap items-end gap-3">
            ...
            <div>
                <label class="block text-xs font-medium text-gray-600 mb-1">เคาน์เตอร์</label>
                <select wire:model="counterId"
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase">ผู้ทำรายการ</th>
                                ...
                                <div class="flex items-center justify-center gap-1 flex-wrap">
                                    ...
                                    @elseif ($trns->flag_cancel === 'R')
                                        ...
                                        <button wire:click="approveCancel({{ $trns->id }})"
                                                wire:confirm="ยืนยันอนุมัติยกเลิกรายการนี้? (Confirm approve cancellation?)"
